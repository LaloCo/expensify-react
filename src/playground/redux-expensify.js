...
const expenseTwo = store.dispatch(addExpense({ description: 'Coffee', amount: 6000, createdAt: -12432 }));
const expenseOne = store.dispatch(addExpense({ description: 'Rent', amount: 200000, createdAt: 1300 }));

// store.dispatch(removeExpense({ id: expenseOne.expense.id }));
// store.dispatch(editExpense(expenseTwo.expense.id, { amount: 7500 }));
